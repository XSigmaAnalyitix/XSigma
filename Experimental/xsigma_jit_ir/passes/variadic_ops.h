...
TORCH_API bool RemoveListMutationAndUseVariadicCat(const std::shared_ptr<Graph>& graph);

TORCH_API bool UseVariadicStack(const std::shared_ptr<Graph>& graph);
TORCH_API bool RemoveListMutationAndUseVariadicStack(const std::shared_ptr<Graph>& graph);
