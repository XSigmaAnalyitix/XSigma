...
public:
    ...
    {
        auto result = impl.try_get_call_ptr(
            device_type,
            reinterpret_cast<void*>(DEFAULT)
#ifdef HAVE_AVX512_CPU_DEFINITION
                ,
...
#define REGISTER_ARCH_DISPATCH(name, arch, fn)                                                   \
    template <>                                                                                  \
    name##_DECLARE_DISPATCH_type::FnPtr TORCH_API                                                \
        DispatchStub<name##_DECLARE_DISPATCH_type::FnPtr, struct name##_DECLARE_DISPATCH_type>:: \
            arch = fn;
...
#define REGISTER_PRIVATEUSE1_DISPATCH(name, fn)                                               \
    static RegisterPRIVATEUSE1Dispatch<struct name##_DECLARE_DISPATCH_type> name##__register( \
        name, fn);
