...
#include <XSigma/native/cpu/CatKernel.h>
#include <XSigma/native/cpu/SerialStackImpl.h>
#include <XSigma/native/cpu/StackKernel.h>
...
#include <XSigma/ops/_conj_copy_native.h>
...
#include <XSigma/ops/_fw_primal_copy_native.h>
#include <XSigma/ops/_indices_copy_native.h>
#include <XSigma/ops/_make_dual.h>
#include <XSigma/ops/_make_dual_copy_native.h>
#include <XSigma/ops/_mkldnn_reshape.h>
#include <XSigma/ops/_mkldnn_transpose.h>
#include <XSigma/ops/_neg_view_copy_native.h>
#include <XSigma/ops/_reshape_alias_copy_native.h>
#include <XSigma/ops/_reshape_alias_native.h>
#include <XSigma/ops/_reshape_copy_native.h>
#include <XSigma/ops/_reshape_from_tensor_native.h>
#include <XSigma/ops/_shape_as_tensor_native.h>
#include <XSigma/ops/_sparse_broadcast_to.h>
#include <XSigma/ops/_sparse_broadcast_to_copy_native.h>
#include <XSigma/ops/_sparse_broadcast_to_native.h>
...
#include <XSigma/ops/_sparse_csr_tensor_unsafe.h>
#include <XSigma/ops/_sparse_csr_tensor_unsafe_native.h>
#include <XSigma/ops/_stack_native.h>
#include <XSigma/ops/_unsafe_view.h>
#include <XSigma/ops/_unsafe_view_native.h>
#include <XSigma/ops/_values_copy_native.h>
#include <XSigma/ops/adjoint_native.h>
#include <XSigma/ops/alias.h>
#include <XSigma/ops/alias_copy_native.h>
#include <XSigma/ops/alias_native.h>
#include <XSigma/ops/arange.h>
#include <XSigma/ops/arange_native.h>
#include <XSigma/ops/as_strided_copy_native.h>
#include <XSigma/ops/as_strided_native.h>
#include <XSigma/ops/as_strided_scatter_native.h>
#include <XSigma/ops/atleast_1d.h>
#include <XSigma/ops/atleast_2d.h>
#include <XSigma/ops/atleast_3d.h>
#include <XSigma/ops/block_diag_native.h>
#include <XSigma/ops/broadcast_tensors_native.h>
#include <XSigma/ops/broadcast_to_native.h>
#include <XSigma/ops/cat.h>
#include <XSigma/ops/cat_meta.h>
#include <XSigma/ops/cat_native.h>
#include <XSigma/ops/chunk_native.h>
#include <XSigma/ops/col_indices_copy_native.h>
#include <XSigma/ops/column_stack_native.h>
#include <XSigma/ops/concat_native.h>
#include <XSigma/ops/concatenate_native.h>
#include <XSigma/ops/crow_indices_copy_native.h>
#include <XSigma/ops/dense_dim_native.h>
#include <XSigma/ops/detach_copy_native.h>
#include <XSigma/ops/detach_native.h>
#include <XSigma/ops/diag.h>
#include <XSigma/ops/diag_embed.h>
#include <XSigma/ops/diag_embed_native.h>
#include <XSigma/ops/diag_native.h>
#include <XSigma/ops/diagflat_native.h>
#include <XSigma/ops/diagonal.h>
#include <XSigma/ops/diagonal_backward.h>
#include <XSigma/ops/diagonal_backward_native.h>
#include <XSigma/ops/diagonal_copy.h>
#include <XSigma/ops/diagonal_copy_native.h>
#include <XSigma/ops/diagonal_native.h>
#include <XSigma/ops/diagonal_scatter_native.h>
#include <XSigma/ops/dsplit_native.h>
#include <XSigma/ops/dstack_native.h>
#include <XSigma/ops/empty.h>
#include <XSigma/ops/empty_like.h>
#include <XSigma/ops/empty_quantized.h>
#include <XSigma/ops/expand_as_native.h>
#include <XSigma/ops/expand_copy_native.h>
#include <XSigma/ops/expand_native.h>
#include <XSigma/ops/flatten_dense_tensors_native.h>
#include <XSigma/ops/flatten_native.h>
#include <XSigma/ops/from_blob.h>
#include <XSigma/ops/hsplit_native.h>
#include <XSigma/ops/hstack.h>
#include <XSigma/ops/hstack_native.h>
#include <XSigma/ops/index_select_native.h>
#include <XSigma/ops/indices_copy_native.h>
#include <XSigma/ops/lift_fresh_native.h>
#include <XSigma/ops/lift_native.h>
#include <XSigma/ops/mH_native.h>
#include <XSigma/ops/mT_native.h>
#include <XSigma/ops/matrix_H_native.h>
#include <XSigma/ops/meshgrid_native.h>
#include <XSigma/ops/moveaxis_native.h>
#include <XSigma/ops/movedim.h>
#include <XSigma/ops/movedim_native.h>
#include <XSigma/ops/narrow.h>
#include <XSigma/ops/narrow_copy.h>
#include <XSigma/ops/narrow_copy_native.h>
#include <XSigma/ops/narrow_native.h>
#include <XSigma/ops/new_empty_native.h>
#include <XSigma/ops/new_ones_native.h>
#include <XSigma/ops/numpy_T_native.h>
#include <XSigma/ops/permute_copy_native.h>
#include <XSigma/ops/permute_native.h>
#include <XSigma/ops/ravel_native.h>
#include <XSigma/ops/repeat_native.h>
#include <XSigma/ops/reshape_as_native.h>
#include <XSigma/ops/reshape_native.h>
#include <XSigma/ops/resize_native.h>
#include <XSigma/ops/row_stack_native.h>
#include <XSigma/ops/select.h>
#include <XSigma/ops/select_backward_native.h>
#include <XSigma/ops/select_copy_native.h>
#include <XSigma/ops/select_native.h>
#include <XSigma/ops/select_scatter_native.h>
#include <XSigma/ops/set_native.h>
#include <XSigma/ops/slice.h>
#include <XSigma/ops/slice_backward_native.h>
#include <XSigma/ops/slice_copy_native.h>
#include <XSigma/ops/slice_inverse_native.h>
#include <XSigma/ops/slice_native.h>
#include <XSigma/ops/slice_scatter_native.h>
#include <XSigma/ops/sparse_coo_tensor.h>
#include <XSigma/ops/sparse_coo_tensor_native.h>
#include <XSigma/ops/sparse_dim_native.h>
#include <XSigma/ops/split_copy_native.h>
#include <XSigma/ops/split_native.h>
#include <XSigma/ops/split_with_sizes.h>
#include <XSigma/ops/split_with_sizes_copy_native.h>
#include <XSigma/ops/split_with_sizes_native.h>
#include <XSigma/ops/squeeze.h>
#include <XSigma/ops/squeeze_copy_native.h>
#include <XSigma/ops/squeeze_native.h>
#include <XSigma/ops/stack_native.h>
#include <XSigma/ops/sub.h>
#include <XSigma/ops/sum.h>
#include <XSigma/ops/sum_to_size_native.h>
#include <XSigma/ops/swapaxes_native.h>
#include <XSigma/ops/swapdims_native.h>
#include <XSigma/ops/t_copy_native.h>
#include <XSigma/ops/t_native.h>
#include <XSigma/ops/tensor.h>
#include <XSigma/ops/tensor_split.h>
#include <XSigma/ops/tensor_split_native.h>
#include <XSigma/ops/tile_native.h>
#include <XSigma/ops/transpose.h>
#include <XSigma/ops/transpose_copy_native.h>
#include <XSigma/ops/transpose_native.h>
#include <XSigma/ops/unbind.h>
#include <XSigma/ops/unbind_copy_native.h>
#include <XSigma/ops/unbind_native.h>
#include <XSigma/ops/unflatten_dense_tensors_native.h>
#include <XSigma/ops/unflatten_native.h>
#include <XSigma/ops/unfold_copy_native.h>
#include <XSigma/ops/unfold_native.h>
#include <XSigma/ops/unsafe_chunk_native.h>
#include <XSigma/ops/unsafe_split_native.h>
#include <XSigma/ops/unsafe_split_with_sizes_native.h>
#include <XSigma/ops/unsqueeze_copy_native.h>
#include <XSigma/ops/unsqueeze_native.h>
#include <XSigma/ops/values_copy_native.h>
#include <XSigma/ops/view_as_complex.h>
#include <XSigma/ops/view_as_complex_copy_native.h>
#include <XSigma/ops/view_as_native.h>
#include <XSigma/ops/view_as_real.h>
#include <XSigma/ops/view_as_real_copy_native.h>
#include <XSigma/ops/view_copy_native.h>
#include <XSigma/ops/view_native.h>
#include <XSigma/ops/vsplit_native.h>
#include <XSigma/ops/vstack.h>
#include <XSigma/ops/vstack_native.h>
#include <XSigma/ops/zeros.h>
#include <XSigma/ops/zeros_like.h>
#include <XSigma/ops/zeros_native.h>
#endif
