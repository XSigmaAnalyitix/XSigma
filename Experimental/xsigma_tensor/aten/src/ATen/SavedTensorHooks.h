...
{
    static void push_hooks(c10::SafePyObject pack_hook, c10::SafePyObject unpack_hook);
    static std::pair<c10::SafePyObject, c10::SafePyObject>                pop_hooks();
    static std::optional<std::pair<c10::SafePyObject, c10::SafePyObject>> get_hooks(
        bool ignore_is_tracing = false);
    ...
    static void disable(const std::string& error_message, const bool fail_if_non_empty = true);
    static void enable();
