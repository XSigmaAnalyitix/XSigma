...
#define SPECIALIZE_CppTypeToScalarType(cpp_type, scalar_type)                   \
    ...
    struct CppTypeToScalarType<cpp_type>                                        \
        : std::integral_constant<c10::ScalarType, c10::ScalarType::scalar_type> \
    {                                                                           \
    };
...
#define DEFINE_CONSTANT(_, name) constexpr ScalarType k##name = ScalarType::name;
...
[[deprecated(
    "isIntegralType is deprecated. Please use the overload with 'includeBool' parameter "
    "instead.")]] inline bool
...
inline bool isQIntType(ScalarType t)
{
    ...
    return t == ScalarType::QInt8 || t == ScalarType::QUInt8 || t == ScalarType::QInt32 ||
           t == ScalarType::QUInt4x2 || t == ScalarType::QUInt2x4;
}

inline bool isBitsType(ScalarType t)
{
    return t == ScalarType::Bits1x8 || t == ScalarType::Bits2x4 || t == ScalarType::Bits4x2 ||
           t == ScalarType::Bits8 || t == ScalarType::Bits16;
}

inline bool isBarebonesUnsignedType(ScalarType t)
{
    return t == ScalarType::UInt1 || t == ScalarType::UInt2 || t == ScalarType::UInt3 ||
           t == ScalarType::UInt4 || t == ScalarType::UInt5 || t == ScalarType::UInt6 ||
           t == ScalarType::UInt7 || t == ScalarType::UInt16 || t == ScalarType::UInt32 ||
           t == ScalarType::UInt64;
}
...
C10_API std::pair<std::string, std::string> getDtypeNames(c10::ScalarType scalarType);
