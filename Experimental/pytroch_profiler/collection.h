...
// ============================================================================
struct XSIGMA_API RawTensorMetadataBase
{
    RawTensorMetadataBase() = default;
    explicit RawTensorMetadataBase(const xsigma::Tensor& t);

    StorageImplData    data_;
    xsigma::ScalarType dtype_{xsigma::ScalarType::Undefined};
    xsigma::Layout     layout_{xsigma::Layout::Strided};
    uint32_t           size_dim_{0};
};

// Collected during profiling.
struct XSIGMA_API RawTensorMetadata : RawTensorMetadataBase
{
...
struct XSIGMA_API TensorMetadata : public RawTensorMetadataBase
{
    TensorMetadata(
...
// Used during post processing.
struct XSIGMA_API ProfilerStepInfo
{
...
class XSIGMA_VISIBILITY TorchOpBasicFields
{
...
class XSIGMA_VISIBILITY FallbackPair
{
...
class XSIGMA_VISIBILITY RawAllocation
{
...
class XSIGMA_VISIBILITY NNModuleInfo
{
...
class XSIGMA_VISIBILITY OptimizerInfo
{
    struct ParameterInfo
    {
        TensorMetadata                                      metadata_;
...
class XSIGMA_VISIBILITY PyExtraFieldsBase
{
...
struct XSIGMA_API Result : public std::enable_shared_from_this<Result>
{
...
class XSIGMA_VISIBILITY KinetoObserverContext : public xsigma::ObserverContext
{
    struct Event
    {
...
class XSIGMA_API ThreadLocalSubqueue
{
public:
