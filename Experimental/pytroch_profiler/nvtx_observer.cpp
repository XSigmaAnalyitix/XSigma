...
class XSIGMA_VISIBILITY NVTXThreadLocalState : ProfilerStateBase
{
    ...
    void setProducerTensorMap(xsigma::TensorImpl* tensor, xsigma::RecordFunctionHandle op_id, int output_nr)
    {
