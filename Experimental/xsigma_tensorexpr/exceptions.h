...
public:
    ...
    explicit malformed_input(const std::string& err) : std::runtime_error("MALFORMED INPUT: " + err)
    {
    }
    ...
    explicit malformed_input(const std::string& err, const ExprPtr& expr)
        : std::runtime_error("MALFORMED INPUT: " + err + " - " + std::to_string(expr))
    {
    }
    ...
    explicit malformed_input(const std::string& err, const StmtPtr& stmt)
        : std::runtime_error("MALFORMED INPUT: " + err + " - " + std::to_string(stmt))
    {
    }
};
...
public:
    ...
    explicit malformed_ir(const std::string& err) : std::runtime_error("MALFORMED IR: " + err) {}
    ...
    explicit malformed_ir(const std::string& err, const ExprPtr& expr)
        : std::runtime_error("MALFORMED IR: " + err + " - " + std::to_string(expr))
    {
    }
    ...
    explicit malformed_ir(const std::string& err, const StmtPtr& stmt)
        : std::runtime_error("MALFORMED IR: " + err + " - " + std::to_string(stmt))
    {
    }
};
