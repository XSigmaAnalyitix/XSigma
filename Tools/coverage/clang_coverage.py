...
def _generate_json_export(build_dir: Path, coverage_dir: Path, binaries: List[str],
                         profraw_files: List[str], output_format: str = "html-and-json") -> None:
...
def _generate_html_from_lcov(lcov_file: Path, coverage_dir: Path) -> bool:
...
def _generate_summary_json_from_lcov(lcov_file: Path, coverage_dir: Path,
    ...
    try:
        ...
        if output_format == "json":
            ...
            _generate_html_from_lcov(lcov_file, coverage_dir)
