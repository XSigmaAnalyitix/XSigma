...
if(XSIGMA_ENABLE_SANITIZER)
  set(XSIGMA_REQUIRED_CXX_FLAGS
      "${XSIGMA_REQUIRED_CXX_FLAGS} -O1 -g -fno-omit-frame-pointer -fno-optimize-sibling-calls"
  )
  set(XSIGMA_REQUIRED_C_FLAGS
      "${XSIGMA_REQUIRED_C_FLAGS} -O1 -g -fno-omit-frame-pointer -fno-optimize-sibling-calls"
  )
endif()
...
if(CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
  # Enable exceptions because XSIGMA and third party code rely on C++ exceptions. Allow C++ to catch
  ...
  set(XSIGMA_REQUIRED_EXE_LINKER_FLAGS
      "${XSIGMA_REQUIRED_EXE_LINKER_FLAGS} -fwasm-exceptions -sEXCEPTION_STACK_TRACES=1"
  )
  set(XSIGMA_REQUIRED_SHARED_LINKER_FLAGS
      "${XSIGMA_REQUIRED_SHARED_LINKER_FLAGS} -fwasm-exceptions -sEXCEPTION_STACK_TRACES=1"
  )
  set(XSIGMA_REQUIRED_MODULE_LINKER_FLAGS
      "${XSIGMA_REQUIRED_MODULE_LINKER_FLAGS} -fwasm-exceptions -sEXCEPTION_STACK_TRACES=1"
  )
...
if(CMAKE_COMPILER_IS_GNUCXX)
  ...
  if(CMAKE_SYSTEM MATCHES "HP-UX.*")
    set(XSIGMA_REQUIRED_C_FLAGS "${XSIGMA_REQUIRED_C_FLAGS} +W2111 +W2236 +W4276")
    set(XSIGMA_REQUIRED_CXX_FLAGS "${XSIGMA_REQUIRED_CXX_FLAGS} +W2111 +W2236 +W4276")
  endif()
endif()
...
# ----------------------------------------------------------------------------- Add compiler flags
# XSIGMA needs to work on this platform.  This must be done after the call to
