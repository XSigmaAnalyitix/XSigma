# =============================================================================
# XSigma System Validation and Checks Module
# =============================================================================
# This module performs efficient system validation with aggressive caching
# to minimize CMake reconfiguration overhead while ensuring all required
# dependencies and capabilities are available.
#
# Performance Optimizations:
# - Cached validation results to avoid redundant checks
# - Fast platform detection with cached results
# - Efficient compiler capability validation
...
set(XSIGMA_VALIDATION_CACHE_KEY "${CMAKE_CXX_COMPILER_ID}_${CMAKE_CXX_COMPILER_VERSION}_${CMAKE_SYSTEM_NAME}_${CMAKE_SYSTEM_VERSION}"
...
# =============================================================================
# Compiler Version Validation (Updated for Modern Requirements)
# =============================================================================
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS ${XSIGMA_MIN_GCC_VERSION})
        message(FATAL_ERROR "XSigma requires GCC ${XSIGMA_MIN_GCC_VERSION} or later for C++17 support and modern optimizations. Found: ${CMAKE_CXX_COMPILER_VERSION}")
    endif()
...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS ${XSIGMA_MIN_CLANG_VERSION})
        message(FATAL_ERROR "XSigma requires Clang ${XSIGMA_MIN_CLANG_VERSION} or later for C++17 support and modern optimizations. Found: ${CMAKE_CXX_COMPILER_VERSION}")
    endif()
...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS ${XSIGMA_MIN_APPLE_CLANG_VERSION})
        message(FATAL_ERROR "XSigma requires Apple Clang ${XSIGMA_MIN_APPLE_CLANG_VERSION} or later for C++17 support and modern optimizations. Found: ${CMAKE_CXX_COMPILER_VERSION}")
    endif()
...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS ${XSIGMA_MIN_MSVC_VERSION})
        message(FATAL_ERROR "XSigma requires MSVC ${XSIGMA_MIN_MSVC_VERSION} or later (Visual Studio 2017 15.7+) for C++17 support and modern optimizations. Found: ${CMAKE_CXX_COMPILER_VERSION}")
    endif()
...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Intel")
    if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS ${XSIGMA_MIN_INTEL_VERSION})
        message(FATAL_ERROR "XSigma requires Intel C++ ${XSIGMA_MIN_INTEL_VERSION} or later for C++17 support and modern optimizations. Found: ${CMAKE_CXX_COMPILER_VERSION}")
    endif()
...
# =============================================================================
# Essential System Dependencies Validation
# =============================================================================
...
if(NOT DEFINED XSIGMA_EXCEPTION_HANDLING_VALIDATED)
    ...
    set(XSIGMA_EXCEPTION_HANDLING_VALIDATED TRUE CACHE INTERNAL "Exception handling validation completed")
...
# =============================================================================
# Validation Completion and Caching
# =============================================================================

# Mark validation as completed for this configuration
set(XSIGMA_VALIDATION_COMPLETED "${XSIGMA_VALIDATION_CACHE_KEY}" CACHE INTERNAL "Validation completed for configuration")
