...
# library.
set(XSIGMA_LOGGING_BACKEND "LOGURU"
...
if(NOT XSIGMA_LOGGING_BACKEND MATCHES "^(NATIVE|LOGURU|GLOG)$")
  message(
    FATAL_ERROR
      "XSIGMA_LOGGING_BACKEND must be NATIVE, LOGURU, or GLOG (got: ${XSIGMA_LOGGING_BACKEND})"
  )
endif()
