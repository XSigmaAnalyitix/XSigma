# =============================================================================
# XSigma Clang-Tidy Static Analysis Configuration Module
# =============================================================================
# This module configures clang-tidy for static code analysis and automated fixes.
# It enables code quality checks and optional automatic error correction.
# =============================================================================

# Include guard to prevent multiple inclusions
include_guard(GLOBAL)

# Clang-Tidy Static Analysis Flag
# Controls whether clang-tidy static analysis is enabled during compilation.
# When enabled, performs comprehensive code quality checks on all targets.
option(XSIGMA_ENABLE_CLANGTIDY "enable clangtidy check" OFF)
mark_as_advanced(XSIGMA_ENABLE_CLANGTIDY)

# Clang-Tidy Auto-Fix Flag
# Controls whether clang-tidy automatically fixes detected errors.
# WARNING: This modifies source files. Use with caution in version control.
