...
// the inputs xsigma runtime match the Generalized Symbolic Shapes that are inputs
...
// examples and walkthrough look xsigma ShapeAnalysisTest.DynamicShapesFusion in
