    ...
    xplane_builder&        dst_plane)
{
    ...
    {
        dst_event_metadata.set_display_name(src_event_metadata.display_name().data());
    }
    if (dst_event_metadata.name().empty() && !src_event_metadata.name().empty())
    {
        dst_event_metadata.set_name(src_event_metadata.name().data());
    }
