...
// #include "experimental/xsigma_parallel/Version.h"
...
#if defined(__APPLE__) && defined(__aarch64__) && !defined(XSIGMA_MOBILE)
...
int intraop_default_num_threads()
{
    ...
    XSIGMA_LOG_ERROR("Undefined intraop_default_num_threads on mobile.");
    return 1;
#else
