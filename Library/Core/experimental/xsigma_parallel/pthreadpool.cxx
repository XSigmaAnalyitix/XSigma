    ...
    size_t                                 tile)
{
    ...
    else
    {
        ...
        legacy_pthreadpool_compute_1d(
            threadpool, (legacy_pthreadpool_function_1d_t)compute_1d_tiled, &context, tile_range);
    }
}
    ...
    size_t                           range_j)
{
    ...
    else
    {
        ...
        legacy_pthreadpool_compute_1d(
            threadpool, (legacy_pthreadpool_function_1d_t)compute_2d, &context, range_i * range_j);
    }
}
    ...
    size_t                                 tile_j)
{
    ...
    else
    {
        ...
        TORCH_DCHECK_LE(tile_range_i * tile_range_j, (size_t)std::numeric_limits<int32_t>::max());
...
static void compute_3d_tiled(void* context_, size_t linear_index)
{
    ...
    context->tile_range_k.DivMod(static_cast<int32_t>(linear_index), &tile_index_ij, &tile_index_k);
    ...
    size_t                                 tile_k)
{
    ...
    else
    {
        ...
        TORCH_DCHECK_LE(
            tile_range_i * tile_range_j * tile_range_k, (size_t)std::numeric_limits<int>::max());
...
static void compute_4d_tiled(void* context_, size_t linear_index)
{
    ...
    context->function(
        context->argument, index_i, index_j, index_k, index_l, tile_i, tile_j, tile_k, tile_l);
}
