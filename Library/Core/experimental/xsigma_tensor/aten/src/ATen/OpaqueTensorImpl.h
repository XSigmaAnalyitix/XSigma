...
struct TORCH_API OpaqueTensorImpl : public TensorImpl
{
    ...
    OpaqueTensorImpl(
        ...
        : TensorImpl(key_set, data_type, device), opaque_handle_(std::move(opaque_handle))
    {
   ...
   */
    ...
    const OpaqueHandle& opaque_handle() const { return opaque_handle_; }

    OpaqueHandle& unsafe_opaque_handle() { return opaque_handle_; }
...
private:
    const char* tensorimpl_type_name() const override { return "OpaqueTensorImpl"; }

    void constructor_impl(c10::IntArrayRef sizes, bool is_non_overlapping_and_dense)
    {
