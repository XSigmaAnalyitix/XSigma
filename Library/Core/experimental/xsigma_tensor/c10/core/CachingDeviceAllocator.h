...
struct C10_API DeviceAllocator : public c10::Allocator
{
    ...
    virtual CachingDeviceAllocator::DeviceStats getDeviceStats(c10::DeviceIndex device) = 0;
...
{
    TORCH_CHECK(t != DeviceType::CPU, "getDeviceAllocator is not supported for CPU device type.");
