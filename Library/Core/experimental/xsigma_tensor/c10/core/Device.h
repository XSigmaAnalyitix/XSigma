...
struct C10_API Device final
{
    ...
    /// index.
    /* implicit */ Device(DeviceType type, DeviceIndex index = -1) : type_(type), index_(index)
    {
        validate();
    }
    ...
    bool is_privateuseone() const noexcept { return type_ == DeviceType::PrivateUse1; }
    ...
    {
        return type_ != DeviceType::IPU && type_ != DeviceType::XLA && type_ != DeviceType::Lazy;
    }
