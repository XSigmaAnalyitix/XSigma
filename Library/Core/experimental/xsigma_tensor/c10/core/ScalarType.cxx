...
constexpr auto index2dtype =
    array_of<c10::ScalarType>(u1, i1, i2, i4, i8, f2, f4, f8, c2, c4, c8, b1, bf);

constexpr std::array<int64_t, static_cast<size_t>(ScalarType::NumOptions)> calculate_dtype2index()
{
...
ScalarType promoteTypes(ScalarType a, ScalarType b)
{
    ...
    if (isQIntType(a) || isQIntType(b))
    {
        TORCH_CHECK(
            false,
            "promoteTypes with quantized numbers is not handled yet; figure out what the correct "
            "rules should be, offending types: ",
            toString(a),
            " ",
            toString(b));
    }
...
#define DEFINE_SCALAR_TYPE(_1, n) c10::ScalarType::n,
    ...
    auto all_scalar_types = {AT_FORALL_SCALAR_TYPES_WITH_COMPLEX_AND_QINTS(DEFINE_SCALAR_TYPE)};
