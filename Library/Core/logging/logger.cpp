...
#endif  // XSIGMA_HAS_NATIVE_LOGGING
...
#elif XSIGMA_HAS_GLOG || XSIGMA_HAS_NATIVE_LOGGING
...
{
#if XSIGMA_HAS_LOGURU || XSIGMA_HAS_GLOG || XSIGMA_HAS_NATIVE_LOGGING
    return true;
#else
    return false;
#endif
