...
private:
   ...
   */
    ...
    std::unique_ptr<tools_impl<BackendType::Sequential>> SequentialBackend;
#else
    std::unique_ptr<toolsDefaultImpl> SequentialBackend;
#endif
...
#else
    std::unique_ptr<toolsDefaultImpl> STDThreadBackend;
#endif
...
#else
    std::unique_ptr<toolsDefaultImpl> TBBBackend;
#endif
   ...
   */
    ...
    std::unique_ptr<tools_impl<BackendType::OpenMP>> OpenMPBackend;
#else
    std::unique_ptr<toolsDefaultImpl> OpenMPBackend;
#endif
};
